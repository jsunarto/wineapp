import { Field, Section, TextInput } from "./formControls";

export default function BottleInfoSection({ icon, update, wine }) {
  return (
    <Section id="bottle" title="Bottle Info" icon={icon}>
      <Field label="Wine"><TextInput value={wine.wine} onChange={(value) => update("wine", value)} placeholder="Reputation" /></Field>
      <Field label="Producer / Label"><TextInput value={wine.producer} onChange={(value) => update("producer", value)} placeholder="Optional" /></Field>
      ...
      <Field label="Grape / Blend"><TextInput value={wine.grape} onChange={(value) => update("grape", value)} placeholder="Cabernet Sauvignon" /></Field>
      ...
      <Field label="Where bought / tasted"><TextInput value={wine.whereBought} onChange={(value) => update("whereBought", value)} placeholder="Costco / Home" /></Field>
      <Field label="Date tasted"><TextInput value={wine.dateAdded} onChange={(value) => update("dateAdded", value)} /></Field>
    </Section>
  );
}
